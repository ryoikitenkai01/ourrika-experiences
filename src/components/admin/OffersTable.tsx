    ...
    return (
      <div className="bg-[var(--color-admin-surface)] border border-[var(--color-admin-border)] rounded-lg p-16 flex flex-col items-center justify-center text-center">
        <div className="w-16 h-16 rounded-full bg-[var(--color-admin-surface-raised)] flex items-center justify-center mb-4">
          <Tag size={24} className="text-[var(--color-admin-text-muted)]" />
        </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-[var(--color-admin-border)]">
                ...
                <th className="text-left px-5 py-3.5 font-sans text-xs font-medium tracking-wider uppercase text-[var(--color-admin-text-muted)] hidden lg:table-cell">
                  Validity
                </th>
                ...
                >
                    ...
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-12 rounded-lg overflow-hidden bg-[var(--color-admin-surface-raised)] flex-shrink-0 relative">
                        {offer.cover_image ? (
                          ...
                          <div className="w-full h-full bg-[var(--color-admin-border)] flex items-center justify-center">
                             <Tag size={16} className="text-[var(--color-admin-text-muted)]" />
                          </div>
                        )}
                      </div>
                  ...
                  <td className="px-5 py-4 hidden sm:table-cell">
                    <div className="flex flex-col">
                      <span className="font-sans text-sm text-emerald-600 font-medium">
                        ...
                        <span className="text-[var(--color-admin-text-muted)] font-normal text-xs uppercase">MAD</span>
                      </span>
                      {offer.original_price && (
                        <span className="font-sans text-xs text-[var(--color-admin-text-muted)] line-through">
                  ...
                  <td className="px-5 py-4 hidden lg:table-cell">
                    <div className="flex flex-col gap-1">
                      <span className="inline-flex items-center gap-1.5 font-sans text-xs text-[var(--color-admin-text)]">
                        <Calendar size={12} className="text-[var(--color-admin-text-muted)]" />
