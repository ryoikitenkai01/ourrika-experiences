...
export function WhatsAppButton({ phoneNumber }: WhatsAppButtonProps) {
  ...
  return (
    <motion.a
      ...
      className="hidden md:flex fixed bottom-6 right-6 z-50 bg-[var(--color-terracotta)] text-[var(--color-sand-light)] p-4 rounded-full shadow-premium hover:bg-[var(--color-surface)] transition-colors duration-300 focus:outline-none"
